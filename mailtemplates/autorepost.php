...
function autorepost_warning($domain, $logo, $subject, $toname, $to, $url) {
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="mobile" align="left" valign="top">
                                                                <p>Dear $toname,<p>
                                                                <p>We will automatically repost your message <i>$subject</i> soon, so that more people will see it.</p>
                                                                <p>If you <b>don't</b> want us to do that, please go to <a href="$url">$url</a> to let us know.</p>
                                                            </td>
                                                        </tr>        
                                                        <tr>
                                                            <td height="20" style="font-size:10px; line-height:10px;"> </td><!-- Spacer -->
