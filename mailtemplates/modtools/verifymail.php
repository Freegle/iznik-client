                                                            ...
                                                            <table width="280" cellpadding="0" cellspacing="0" border="0" class="container" align="left">
                                                                <tr>
                                                                    <td width="280" class="mobile" style="font-size:12px; line-height:18px;">
                                                                        <img src="https://iznik.modtools.org/images/logo-large.jpg" width="280" height="280" style="margin:0; padding:0; border:none; display:block;" alt="" class="imgClass" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                        ...
                                                                        <table width="170" cellpadding="0" cellspacing="0" align="left" border="0">
                                                                            <tr>
                                                                                <td width="170" height="36" bgcolor="#00008B" align="center" valign="middle"
                                                                                    ...
                                                                                    <a href="$confirm" target="_blank" alias="" style="font-family: Century Gothic, Arial, sans-serif; text-decoration: none; color: #ffffff;">Confirm my email</a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        <!-- End Button -->
