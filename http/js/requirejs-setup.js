...
requirejs.config({
    ...
    paths: {
        ...
        "fileupload-image": "/js/lib/jquery-file-upload/jquery.fileupload-image",
        "fileupload-process": "/js/lib/jquery-file-upload/jquery.fileupload-process",
        "load-image": "/js/lib/jquery-file-upload/load-image",
        "load-image-orientation": "/js/lib/jquery-file-upload/load-image-orientation",
        "load-image-meta": "/js/lib/jquery-file-upload/load-image-meta",
        "load-image-exif": "/js/lib/jquery-file-upload/load-image-exif",
        "load-image-exif-map": "/js/lib/jquery-file-upload/load-image-exif-map",
        "canvas-to-blob": "/js/lib/jquery-file-upload/canvas-to-blob",
