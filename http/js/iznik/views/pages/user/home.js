  ...
  Iznik.Views.User.Outcome = Iznik.Views.Modal.extend({
    ...
    defaultText: function () {
      ...
      switch (this.$('.js-outcome').val()) {
        case 'Taken':
          text = 'Thanks, this has now been taken.'
          break
        case 'Received':
          text = 'Thanks, this has now been received.'
          break
        case 'Withdrawn':
          text = this.model.get('type') == 'Offer' ? 'Sorry, this is no longer available.' : 'Thanks, I\'m no longer looking for this.'
          break
      }
