...
var r = require('googlemaps-js-rich-marker');
var RichMarker = r.default.RichMarker;
RichMarker.prototype.animateTo = google.maps.Marker.prototype.animateTo;
RichMarker.prototype.stopAnimation = google.maps.Marker.prototype.stopAnimation;
RichMarker.prototype.setAnimation = google.maps.Marker.prototype.setAnimation;
...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        // Browser globals
        root.SlidingRichMarker = factory(root, root.jQuery);
    }
}(this,
    function (root, $) {
        'use strict';
        ...
        var OriginalMarker = RichMarker; //Store original in case it will be replaced in initializeGlobally().
        ...
        var animateTo,
            markerAnimate_AnimateTo_Wrapper = function(destPosition, easing, duration) { //default implementation based on markerAnimate
                ...
                RichMarker.prototype.animateTo.apply(this, arguments);
            };
        ...
        var defaultOptions = {
            ...
            animateFunctionAdapter: function (marker, destPosition, easing, duration) {
                if (!animateTo) {
                    if (!RichMarker.prototype.animateTo) {
        ...
        var decorates = function (childCtor, parentCtor) {
            ...
            //TODO: google.maps.MVCObject.prototype.set if object instanceof OriginalMarker
            ...
            $.extend(childCtor.prototype, {
                ...
                set: function (key, value) {
                    ...
                    if (key === "position" && that instanceof SlidingRichMarker) {
        ...
        google.maps.event.addListener = function (instance, eventName, handler) {
            ...
            if (instance instanceof SlidingRichMarker) {
        ...
        //constructor
        var SlidingRichMarker = function (opt_options) {

            opt_options = $.extend({}, defaultOptions, opt_options);

            this._instance = new OriginalMarker(opt_options);

            this.animationPosition = null;

            this._constructing = true;
            // Call the parent constructor.
            OriginalMarker.call(this, opt_options);
        ...
        decorates(SlidingRichMarker, OriginalMarker);

        //Overrides
        $.extend(SlidingRichMarker.prototype, {
