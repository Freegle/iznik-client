...
// and the second argument - flag - preferred type is a string
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        var store = shared.store || (shared.store = new (__webpack_require__(102))());
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        if (__webpack_require__(8)) {
            ...
            var fails = __webpack_require__(3);
            var $export = __webpack_require__(0);
            var $typed = __webpack_require__(52);
            ...
            var toInteger = __webpack_require__(23);
            var toLength = __webpack_require__(6);
            var toIndex = __webpack_require__(100);
...
// easier to handle this case. if(!global) { ...}
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        var _Mode = __webpack_require__(128);
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        var _Match = __webpack_require__(92);

        var _Match2 = _interopRequireDefault(_Match);

        var _MatchOptions = __webpack_require__(91);
...
// Finds the longest match in given texts. It uses indexing with fixed granularity that is used to compare blocks of text.
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        var _Action = __webpack_require__(132);
        ...
        var _MatchFinder = __webpack_require__(131);

        var _MatchFinder2 = _interopRequireDefault(_MatchFinder);

        var _Operation = __webpack_require__(130);
        ...
        var _WordSplitter = __webpack_require__(129);
        ...
        var HtmlDiff = function () {
            ...
            _createClass(HtmlDiff, [{
                ...
                value: function performOperation(opp) {
                    switch (opp.action) {
                        case _Action2.default.equ:
                            this.processEqualOperation(opp);
                            break;
                        case _Action2.default.del:
                            this.processDeleteOperation(opp, "diffdel");
                            break;
                        case _Action2.default.ins:
                            this.processInsertOperation(opp, "diffins");
                            break;
                        case _Action2.default.non:
                            break;
                        case _Action2.default.rep:
                    ...
                    try {
                        for (var _iterator2 = matchesWithoutOrphans[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                            ...
                            if (!matchStartsAtCurrentPositionInOld && !matchStartsAtCurrentPositionInNew) {
                                action = _Action2.default.rep;
                            } else if (matchStartsAtCurrentPositionInOld && !matchStartsAtCurrentPositionInNew) {
                                action = _Action2.default.ins;
                            } else if (!matchStartsAtCurrentPositionInOld) {
                                action = _Action2.default.del;
                            } else {
                                action = _Action2.default.non;
                            }

                            if (action !== _Action2.default.non) {
...
// https://github.com/benjamingr/RexExp.escape
        var $export = __webpack_require__(0);
        var $re = __webpack_require__(134)(/[\\^$*+?.()|[\]{}]/g, '\\$&');
...
// https://rwaldron.github.io/proposal-math-extensions/
        ...
        $export($export.S, 'Math', { scale: __webpack_require__(93) });
...
// https://tc39.github.io/proposal-setmap-offrom/#sec-weakset.from
        __webpack_require__(49)('WeakSet');
...
// B.2.2.5 Object.prototype.__lookupSetter__(P)
        __webpack_require__(8) && $export($export.P + __webpack_require__(51), 'Object', {
...
// https://github.com/tc39/proposal-string-pad-start-end
        var $export = __webpack_require__(0);
        var $pad = __webpack_require__(97);
        var userAgent = __webpack_require__(64);
...
// 20.3.4.36 / 15.9.5.43 Date.prototype.toISOString()
        var $export = __webpack_require__(0);
        var toISOString = __webpack_require__(254);
...
// 19.1.3.10 Object.is(value1, value2)
        var $export = __webpack_require__(0);
        $export($export.S, 'Object', { is: __webpack_require__(316) });
